...
function lowestRatingResponseFunction(lowestValue) {
  ...
  const conditionDescriptions = {
    ...
    2: "(critical condition) due to the condition of the XXXXX",
    3: "(serious condition) due to the condition of the XXXXX",
    4: "(poor condition) due to the condition of the XXXXX",
